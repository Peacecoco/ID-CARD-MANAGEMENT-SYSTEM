    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .results-table {
            ...
            border: 1px solid rgba(126, 118, 127, 0.18);
            border-radius: 8px;
            overflow: hidden;
        }
        ...
        .results-table td {
            padding: 12px 14px;
            border-bottom: 1px solid rgba(126, 118, 127, 0.14);
            text-align: left;
            vertical-align: middle;
        }

        .results-table thead th {
            background: rgba(220, 199, 225, 0.5);
            color: var(--heading);
            font-weight: 700;
            font-size: 0.9rem;
        }
        ...
        .results-table tbody tr:nth-child(even) {
            background: rgba(240, 235, 240, 0.38);
        }

        .results-table tbody tr:hover {
            background: rgba(217, 185, 234, 0.15);
        }
        ...
        .result-badge {
            ...
            padding: 6px 10px;
            border-radius: 999px;
            background: rgba(76, 157, 117, 0.13);
            color: var(--success);
            font-size: 0.78rem;
            font-weight: 700;
